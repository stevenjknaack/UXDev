# CS571 S24 HW11 API Documentation
...
`GET` `https://cs571.org/api/s24/hw11/chatrooms`
...
`GET` `https://cs571.org/api/s24/hw11/messages?chatroom=CHATROOM_NAME&num=NUM`
...
### Registering a User
`POST` `https://cs571.org/api/s24/hw11/register`
...
`POST` `https://cs571.org/api/s24/hw11/login`
...
`POST` `https://cs571.org/api/s24/hw11/messages?chatroom=CHATROOM_NAME`
...
### Deleting a Message
`DELETE` `https://cs571.org/api/s24/hw11/messages?id=MESSAGE_ID`
...
### Logging out
`POST` `https://cs571.org/api/s24/hw11/logout`
...
### Who Am I?
`GET` `https://cs571.org/api/s24/hw11/whoami`
